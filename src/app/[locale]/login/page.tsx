...
const LoginPage = () => {
    ...
    const schema = yup.object({
        ...
        role: yup.string().oneOf(['candidate', 'employer']).required(t('login.role_required')),
    }).required();
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    ...
                                    <button
                                        ...
                                        className={`absolute inset-y-0 right-0 pr-3 ${errors?.password?.message ? 'pb-6' : ''}  flex items-center`}
                                    >
                                        {showPassword ? (
                                            <HideEye />
                                        ) : (
                    ...
                    <div className="mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-gray-100 text-gray-500">{t('login.or')}</span>
                            </div>
                        </div>
