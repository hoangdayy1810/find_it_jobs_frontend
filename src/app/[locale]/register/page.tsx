...
const RegisterPage = () => {
    ...
    const schema = yup.object({
        userName: yup.string()
            ...
            .matches(
                /^[a-zA-Z0-9]+$/,
                t('register.username_alphanumeric')
            ),
        password: yup.string()
        ...
        role: yup.string().oneOf(['candidate', 'employer']).required(t('register.role_required')),
    }).required();
    ...
    return (
        <div className="flex">
                    ...
                    <form className="mt-6 space-y-6" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    ...
                                    <button
                                        ...
                                        className={`absolute inset-y-0 right-0 pr-4 ${errors?.password?.message ? 'pb-6' : ''}  flex items-center`}
                                    >
                                        {showPassword ? (
                                            <HideEye />
                                        ) : (
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    ...
                                    <button
                                        ...
                                        className={`absolute inset-y-0 right-0 pr-4 ${errors?.confirmPassword?.message ? 'pb-6' : ''}  flex items-center`}
                                    >
                                        {showConfirmPassword ? (
                                            <HideEye />
                                        ) : (
                        ...
                        <div>
                            <button
                                ...
                                disabled={loading}
                            >
                                {loading ? t('register.register_loading') : t('register.register_button')}
                            </button>
                        </div>
                    </form>
            ...
            <Modal isOpen={isOpenModal} modalMessage={modalMessage} onClose={handleClose} />
        </div>
    );
};
